  ...
  <Builder :href="route('api.return-stock.history')">
    <template v-slot:thead="{table}">
      <tr>
        ...
        <Th class="px-3 py-2 uppercase border-b-2 border-x-2 border-slate-300" :table="table" name="note">keterangan</Th>
    ...
    <template #tfoot>
      ...
      <Th class="p-2 uppercase border-t-2 border-x-2 border-slate-300" :sortable="false">keterangan</Th>
